...
left_shift S0(.A(out0_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0000),.result(temp_15));
left_shift S1(.A(out1_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0001),.result(temp_14));
left_shift S2(.A(out2_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0010),.result(temp_13));
left_shift S3(.A(out3_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0011),.result(temp_12));
left_shift S4(.A(out4_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0100),.result(temp_11));
left_shift S5(.A(out5_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0101),.result(temp_10));
left_shift S6(.A(out6_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0110),.result(temp_9));
left_shift S7(.A(out7_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_0111),.result(temp_8));
left_shift S8(.A(out8_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1000),.result(temp_7));
left_shift S9(.A(out9_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1001),.result(temp_6));
left_shift S10(.A(out10_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1010),.result(temp_5));
left_shift S11(.A(out11_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1011),.result(temp_4));
left_shift S12(.A(out12_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1100),.result(temp_3));
left_shift S13(.A(out13_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1101),.result(temp_2));
left_shift S14(.A(out14_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1110),.result(temp_1));
left_shift S15(.A(out15_16x1),.B(32'b0000_0000_0000_0000_0000_0000_0000_1111),.result(temp_0));
